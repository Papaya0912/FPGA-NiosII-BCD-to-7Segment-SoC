...
module BCDto7Seg_mm_interconnect_0_router_default_decode
  #(
...
module BCDto7Seg_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    BCDto7Seg_mm_interconnect_0_router_default_decode the_default_decode(
